...
class MeituanWorker(QThread):
    ...
    def get_meituan_sum(self, date: datetime) -> Tuple[float, int]:
    ...
    def get_good_num(self,working_datetime:datetime) -> int:
        ...
        query    = {
            ...
            "tagId": "1",
            "startDate": working_datetime.strftime('%Y-%m-%d'),
            "endDate": working_datetime.strftime('%Y-%m-%d'),
            "pageNo": "1",
            "pageSize": "20",
            "referType": "0",
            "category": "0",
